...
| `VDB_SOURCE_MAX_FILES` | `5000` | `ingest-dir` ve corpus inventory başına desteklenen kaynak dosyası sayısı; limit aşımında işleme başlamaz |
| `VDB_SOURCE_MAX_TOTAL_BYTES` | `1000000000` | `ingest-dir`/inventory toplam kaynak byte bütçesi; RAM/çalışma süresi garantisi değildir |
